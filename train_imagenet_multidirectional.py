...
def main_worker(gpu, ngpus_per_node, args):
    ...
    bidirectional_alexnet_parameters = model_parameters()
    model = MultiDirectional(input_size,
                             output_size,
...
def train(train_loader, model, criterion, optimizer, epoch, args, flags):
...
def model_parameters():
    ...
    return bidirectional_alexnet_parameters
